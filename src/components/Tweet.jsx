        ...
        <div className="flex-1 min-w-0" onClick={preventPropagation}>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              {tweet.userId === authUser.uid && isAdmin && (
            ...
            <div className="flex items-center gap-2">
              {/* Botón eliminar del autor (aparece on hover) */}
              <div className="flex items-center opacity-0 group-hover:opacity-100 transition-opacity">
                {currentUser && tweet.userId === currentUser.uid && (
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-500 group-hover:text-red-500">
                      <path d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                    </svg>
                  </button>
                )}
              </div>
              {/* Botón eliminar para administradores, siempre visible */}
              {isAdmin && tweet.userId !== currentUser?.uid && (
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-yellow-500">
